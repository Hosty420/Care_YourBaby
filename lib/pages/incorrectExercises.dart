        ...
        child: Column(
          children: <Widget>[
            ListTile(
              ...
              subtitle: Text(
                  'También hay que tener mucho cuidado con la práctica de los abdominales '
                  'tradicionales,  tipo ‘crunch’. Están contraindicados. Deberemos  tener '
                  'cuidado con las incorporaciones, haciéndolas de costado. Si no, se provocará '
                  'más división de los rectos abdominales, y se acentúa la diástasis abdominal.'),
            ),
          ...
          children: <Widget>[
            ListTile(
              title: Text('NO HIDRATARSE',
                  ...
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              subtitle: Text(
                  '“La hidratación es sumamente importante. Si se llega a tener sed, ya será '
                  'tarde. A nivel corporal ha comenzado una deshidratación”, afirma Villar.'),
            ),
            SizedBox(height: 10.0),
            Positioned.fill(
              child: Image.asset(
